...
class BoardController: NSObject,
  ...
  private func applyNumLettersSettings(with settings: [String: Any]) {
    // START YOUR CODE HERE
      guard let numLettersPerRow = settings[kNumLettersKey] as? Int else {
          print("No number of letters per row was specified")
          return
      }
      
      numItemsPerRow = numLettersPerRow
  ...
  private func applyNumGuessesSettings(with settings: [String: Any]) {
    // START YOUR CODE HERE
      ...
      guard let numGuess = settings[kNumGuessesKey] as? Int else {
          print("No number of guesses was specified")
          return
      }
  ...
  private func applyThemeSettings(with settings: [String: Any]) {
    // START YOUR CODE HERE
      ...
      let wordTheme: WordTheme
      
      if var wordThemeString = settings[kWordThemeKey] as? String {
          wordTheme = WordTheme(rawValue: wordThemeString) ?? WordTheme.normal
      } else {
          print("No word theme was specified")
          return
      }
  ...
  private func applyIsAlienWordleSettings(with settings: [String: Any]) {
    // START YOUR CODE HERE
      ...
      if var isAlien = settings[kIsAlienWordleKey] as? Bool {
